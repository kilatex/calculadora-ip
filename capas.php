...
<body>
    ...
    <div class="cotainer">
        ...
        <div class="row mt-5">
            <div class="col-md-10 offset-md-1    bg-primary p-5 border rounded ">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-5 offset-md-1">
                <img src="./img/./enlace-datos.png" class="mt-3  " alt="">
            </div>
        </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-4 offset-md-1">
                <img src="./img/./internet.png" style="width: 600px;" class="mt-3 " alt="">
            </div>

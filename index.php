...
<body>
    ...
    <div class="cotainer">
        ...
        <h1 class="text-center mt-3 bg-primary text-white">Aplicación TCP/IP</h1>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-5 offset-md-1 mt-5">
                <img class="mt-3" src="./img/tcp-ip.png" alt="">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-5 mt-5 offset-md-1">
                <img src="./img/./ivp4.gif" class="mt-3" alt="">
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6 offset-md-3  bg-primary p-5 border rounded">
